...
from espnet.separation.pytorch_backend.separation import enhance
from espnet.separation.pytorch_backend.separation import enhance_chime6
...
def main(args):
    ...
    parser.add_argument('--use-bf-test', type=strtobool, default=False,
                        help='Apply MVDR while testing')
    parser.add_argument('--chime6', type=strtobool, default=False,
                        help='Use on chime6 long recordings testing')
    parser.add_argument('--segments', default=20, type=int,
                        help='Num of segments to split for chime6')
