...
def main(cmd_args):
    ...
    parser.add_argument('--bftype', default='mvdr_pit', type=str,
                        choices=['mvdr_pit', 'mvdr_denoise', 'mvdr_xvec', 'mvdr_xvec_lhuc', 'mvdr_ts'],
    ...
    if args.model_module is None:
        args.model_module = "espnet.nets." + args.backend + "_backend.separation_net:BleachNet"
    ...
    if args.num_spkrs >= 1:
        if args.backend == "pytorch":
            from espnet.separation.pytorch_backend.separation import train
            train(args)
        else:
